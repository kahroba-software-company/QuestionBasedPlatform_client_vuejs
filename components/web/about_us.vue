...
<div class="flex flex-col justify-center m-auto">
   <div class="flex md:flex-row flex-col bg-teal-200 justify-center md:text-right text-center">
   ...
   <div class="flex md:flex-row flex-col bg-indigo-200 justify-center md:text-right text-center">
      <div class="flex flex-col justify-center items-center relative">
         <div class="w-56 h-12 md:flex hidden justify-center">
   ...
   <div class="flex md:flex-row flex-col bg-pink-200 justify-center md:text-right text-center">
      <div class="flex flex-col justify-center items-center relative">
         <div class="w-56 h-12 md:flex hidden justify-center">
